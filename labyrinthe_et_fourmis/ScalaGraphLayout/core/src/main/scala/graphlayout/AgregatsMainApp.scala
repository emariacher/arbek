...
object Tribu {
  val tribus =
  //List(new Tribu(new Couleur("rouge")), new Tribu(new Couleur("vertFonce")), new Tribu(new Couleur("violet")))
    List(new Tribu(new Couleur("orange")), new Tribu(new Couleur("vertFonce")),
