        ...
        num match {
            ...
            case 4 => {
                val ref = List(new Euler76Func(2, 0, List(1, 1)),
                    new Euler76Func(3, List(1, 1)), new Euler76Func(4, List(1, 2)),
                    ...
                    new Euler76Func(16, List(5, 5)), new Euler76Func(16, List(2, 6)), new Euler76Func(17, List(3, 6)), new Euler76Func(18, List(4, 6)), new Euler76Func(18, List(1, 7)), new Euler76Func(19, List(5, 6)), new Euler76Func(19, List(2, 7)), new Euler76Func(20, List(6, 6)), new Euler76Func(20, List(3, 7)), new Euler76Func(21, List(4, 7)), new Euler76Func(21, List(1, 8)), new Euler76Func(22, List(5, 7)), new Euler76Func(22, List(2, 8)))
            ...
            case 5 => {
                val ref = List(new Euler76Func(3, 0, List(1, 1, 1)),
                    new Euler76Func(4, List(1, 1, 2)), new Euler76Func(5, List(1, 2, 2)),
                    ...
                    new Euler76Func(11, List(1, 2, 4)), new Euler76Func(11, List(3, 3, 3)))
                val l3 = ref.map(_.f(n)).filter(_ > 0)
                sum = l3.sum
                println("                 " + num + " - " + l3 + " " + sum)
                var lse = lsi
