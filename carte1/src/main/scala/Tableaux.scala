...
object Tableaux {
	var tbx: Tableaux = _
			def newTbx(zp: ZePanel, maxRow: Int, maxCol: Int, size: Dimension, origin: Dimension) {
...
class Tableaux(val zp: ZePanel, val maxRow: Int, val maxCol: Int, val size: Dimension, val origin: Dimension) {
	var state = StateMachine.generate
			var cb = new CarteBlanche
	var carte: Coloriage = _
	var seedIndex = 0
	val seeds = List(0, -2002675365, -1995825069, -2000188942, -2003116831, -1996108355, -1995594583)
