...
class PiezoList(val lpz: List[Piezo5NoGraphic]) {
    ...
    val nodeChart = D3Charts.ForceDiagram(fits.groupBy(_._1.substring(0, 4)).zipWithIndex.map(zl => zl._1._2.map(z => (z._1, (zl._2.toInt + 1).toString, z._3.toInt.toString))).flatten.toList,
