...
object SparseVec {
    ...
    implicit def canBuildFrom[A: Numeric: ClassTag]: CanBuildFrom[SparseVec[A], A, SparseVec[A]] =
    ...
    def newBuilder[A: Numeric: ClassTag]: Builder[A, SparseVec[A]] = new ArrayBuffer[A] mapResult fromSeq[A]

    /*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
    /** Build a numeric SparseVector from a numeric sequence.
     */
    def fromSeq[A: Numeric: ClassTag](buf: Seq[A]): SparseVec[A] = 
    {
    ...
    /*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
    def fill[A: Numeric: ClassTag](dim: Int)(f: => A): SparseVec[A] = fromSeq(Array.fill(dim)(f).toSeq)

    /*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
    def one[A: Numeric: ClassTag](j: Int, dim: Int): SparseVec[A] = {
 ...
 */
class SparseVec[A: Numeric: ClassTag] protected (x: ListMap[Int, A])
