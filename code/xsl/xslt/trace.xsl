...
<h2>traces by <a HREF="mailto:emariacher@netcourrier.com">Eric Mariacher</a></h2>
<xsl:apply-templates/> 
</body>
</html>
</xsl:template>
...
<xsl:template match="trace">
  ...
  <hr /><table cellspacing="0">
   ...
   <xsl:apply-templates select="re[td=//tasklist/it[n='TA1']/v and ty=//traceattr/lvl/it[n='2']/v]"/>
  </table>
...
<xsl:template name="tracetable">
 <xsl:param name="filter">zobi</xsl:param>
  ...
  <th>source file</th><th>sou rce line</th><th width="8%">function</th><th>tra ce in dex</th>
