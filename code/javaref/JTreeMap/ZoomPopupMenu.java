...
public static final Icon UNZOOM_ICON = new ImageIcon(ZoomPopupMenu.class.getResource("unzoom.png"));

    /**
     * Zoom icon
     */
//  public static final Icon UNZOOM_ICON = new ImageIcon(ZoomPopupMenu.class.getResource("icons/unzoom.png"));
public static final Icon ZOOM_ICON = new ImageIcon(ZoomPopupMenu.class.getResource("zoom.png"));
