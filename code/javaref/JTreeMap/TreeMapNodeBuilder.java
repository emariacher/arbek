...
public class TreeMapNodeBuilder implements Serializable {
    ...
    public TreeMapNode buildLeaf(final String label, final double weight, final Value value,
    		final double hue, final TreeMapNode parent) {
      final TreeMapNode node = new TreeMapNode(label, weight, value, hue);
      if (parent != null) {
          parent.add(node);
      } else if (this.root == null) {
          this.root = node;
    ...
    public TreeMapNode buildLeaf(final String label, final double weight, final Value value,
    		final double hue, final String details, final TreeMapNode parent) {
      final TreeMapNode node = new TreeMapNode(label, weight, value, hue, details);
      if (parent != null) {
          parent.add(node);
      } else if (this.root == null) {
          this.root = node;
