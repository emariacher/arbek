    ...
    public int donneCouleursPossibles() {
        ...
        for(int k=0; k<4; k++) {
           ...
           if(couleurConsommee[k] == 1) {
               ...
               // forTrace = forTrace + " [30m couleurPossibles[" + nbreCouleursDifferentes + "]=" + couleurPossibles[nbreCouleursDifferentes] + " ";
        ...
        for(int i=0; i<nbre_region; i++) {
            if(regiont[i].couleur==ZOB) {
                ...
                if((nbreCouleursDifferentes == 3)||((i==maxNbreCouleurVoisins)&&(findMax==2))) {
                    ...
                    Service.trace("[30m !" + findMax + "! " + regiont[i].toString(i,false) + "");
                    ...
                    updateMap();
                    Service.trace(0,"" + regiont[i].toString(i,false) + " a des voisins de " + nbreCouleursDifferentes + " couleurs differentes.  \n" + forTrace);
                    int back_cpt = 0;
                    logIndex--;
