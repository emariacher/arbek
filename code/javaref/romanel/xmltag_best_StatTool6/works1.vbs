Sub trend6()
    ...
    For Each ws In ActiveWorkbook.Worksheets
        ...
        End With
        If ws.Name Like "*D" Then
        ws.Select
        ws.Activate

                        Sheets("_A_eQuadDJPlatformD").Range("A1:E18").Select
End If
        Charts.Add
        ...
        With ActiveChart
                .HasTitle = True
                        ...
                        ActiveChart.SeriesCollection(2).Interior.ColorIndex = 45
                        ActiveChart.SeriesCollection(1).Border.LineStyle = xlNone
                        ActiveChart.SeriesCollection(1).Interior.ColorIndex = 43
        End With
        End If
