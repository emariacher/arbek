 ...
 */
public class SeapineStatTool6 extends JPanel implements ActionListener, DefVar {
	/**
	 * 
	 */
	...
	SeapineStatTool6Parser sstp;


	/**  Constructor for the SeapineStatTool6 object */
	public SeapineStatTool6() {
	...
	private void addWidgets() {
		...
		String toolTitleLabel2Txt  = new String("Seapine Stat Tool6");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource() == jbOpenSeapineExportTxtFile) {
			int returnVal  = JFileChooser4SeapineExportTxtFile.showOpenDialog(SeapineStatTool6.this);
			...
			try {
				sstp = new SeapineStatTool6Parser(this);
