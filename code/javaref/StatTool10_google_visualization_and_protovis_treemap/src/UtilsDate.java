...
public class UtilsDate {
	...
	static int getMonth(Calendar c) {
	 ...
	 *@return        Description of the Return Value
	 */
	static Calendar get1erLundi(int annee, int mois) {
	...
	static Calendar get1erJourDaysAgo(long daysAgo) {
		Calendar c  = Calendar.getInstance();
	...
	static Calendar get1erJour(int annee, int mois) {
		Calendar c = Calendar.getInstance();
		int i_today = Calendar.getInstance().get(Calendar.DAY_OF_WEEK);
		c.set(annee, mois, 1);
		while (c.get(Calendar.DAY_OF_WEEK) != i_today) {
	 ...
	 *@return        Description of the Return Value
	 */
	static Calendar getDernierLundi(int annee, int mois) {
		Calendar c  = Calendar.getInstance();
		c.set(annee, mois, 1);
	 ...
	 *@return        Description of the Return Value
	 */
	static int get1stWeek(int annee, int mois) {
	 ...
	 *@return        Description of the Return Value
	 */
	static int getLastWeek(int annee, int mois) {
	 ...
	 *@return    Description of the Return Value
	 */
	static String printXLS(Calendar c) {
	 ...
	 *@return    Description of the Return Value
	 */
	static String print(Calendar c) {
		if(c == null) {
	...
	private long l_startInMillis;
	private long l_duration;
	UtilsDate(){
		l_startInMillis = Calendar.getInstance().getTimeInMillis();
	}
	public long measure(){
		return l_duration = Calendar.getInstance().getTimeInMillis() - l_startInMillis;
	}
	public String toString(){
		return new String(""+l_duration+" ms");
	}


	public static String print4js(Calendar c) {
		return new String(c.get(Calendar.YEAR)+","+c.get(Calendar.MONTH)+","+c.get(Calendar.DAY_OF_MONTH));
	}
}
