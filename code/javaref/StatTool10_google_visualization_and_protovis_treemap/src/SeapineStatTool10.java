 ...
 *@created    16 Décembre 2010
 */
public class SeapineStatTool10 extends JPanel implements ActionListener, DefVar {
	/**
	 * 
	 */
	...
	private void addWidgets() {
		...
		String toolTitleLabel1Txt  = new String(getClass().getName());
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource() == jbOpenSeapineExportTxtFile) {
			int returnVal  = JFileChooser4SeapineExportTxtFile.showOpenDialog(SeapineStatTool10.this);
			...
			try {
				new SeapineStatTool10Parser(this);
