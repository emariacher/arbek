 ...
 */
public class SeapineStatTool4 extends JPanel implements ActionListener, DefVar {
  JFrame buildFrame;
  JPanel buildPanel;
  ...
  File SeapineExportTxtFile                       = null;
  SeapineStatTool4Parser sstp;


  /**  Constructor for the SeapineStatTool4 object */
  public SeapineStatTool4() {
  ...
  private void addWidgets() {
    ...
    String toolTitleLabel2Txt  = new String("Seapine Stat Tool2");
    ...
    try {
      defvardiff = new File("SeapineStatTool4");
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if(event.getSource() == jbOpenSeapineExportTxtFile) {
      int returnVal  = JFileChooser4SeapineExportTxtFile.showOpenDialog(SeapineStatTool4.this);

      if(returnVal == JFileChooser.APPROVE_OPTION) {
        SeapineExportTxtFile = JFileChooser4SeapineExportTxtFile.getSelectedFile();
        jlblFileChooser4SeapineExportTxtFile.setText(SeapineExportTxtFile.getName());
        jbAnalyze.setEnabled(true);
        AnalyzeLabel.setEnabled(true);
      }
          //} else if(event.getSource() == jbAnalyze) {
      try {
        sstp = new SeapineStatTool4Parser(this);
  ...
  private static void createAndShowGUI() {
    ...
    SeapineStatTool4 build  = new SeapineStatTool4();
  }



  /**
   *  The main program for the SeapineStatTool4 class
   *
