 ...
 */
public class Linkedin2HMI extends JPanel implements ActionListener, DefVar {
	...
	public Linkedin2HMI() {
		...
		buildFrame = new JFrame("linkedin2");
	...
	private static void createAndShowGUI() {
		...
		Linkedin2HMI build = new Linkedin2HMI();
	}
