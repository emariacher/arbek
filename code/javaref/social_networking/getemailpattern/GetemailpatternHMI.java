 ...
 */
public class GetemailpatternHMI extends JPanel implements ActionListener, DefVar {
	 ...
	 */
	public GetemailpatternHMI() {
		super(new BorderLayout());
		//Create and set up the window.
		buildFrame = new JFrame("Getemailpattern");
	...
	private void addWidgets() {
		...
		try {
			defvardiff = new File("Getemailpattern");
	...
	private static void createAndShowGUI() {
		...
		GetemailpatternHMI build = new GetemailpatternHMI();
	}
